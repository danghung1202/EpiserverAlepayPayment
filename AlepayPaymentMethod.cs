...
namespace Foundation.Commerce.Payment.Alepay
{
    ...
    public class AlepayPaymentMethod : IPaymentMethod
    {
        ...
        public AlepayPaymentMethod() : this(ServiceLocator.Current.GetInstance<IOrderGroupFactory>())
        {
        }

        public AlepayPaymentMethod(IOrderGroupFactory orderGroupFactory)
        {
            _orderGroupFactory = orderGroupFactory;

            var paymentMethodDto = AlepayConfiguration.GetAlepayPaymentMethod();
        ...
        {
            var payment = orderGroup.CreatePayment(_orderGroupFactory, typeof(AlepayPayment));
